...
function HeaderCongViec({navigation}) {
    return (
        <View style={styles.view_header}>
            ...
            <View style={styles.view_title}>
                <Text style={styles.title_nhanvien}>Quản lý công việc</Text>
            </View>
            <TouchableOpacity onPress={()=>navigation.navigate("screenThemSanPham")} style={[styles.view_image, { alignItems: "flex-end", marginHorizontal: 10 }]}>
                <Image resizeMode={"cover"} style={styles.image_add} source={require('../../../../../Images/Icons/icons_add.png')} />
            </TouchableOpacity>
        </View>
    );
}
export default HeaderCongViec;

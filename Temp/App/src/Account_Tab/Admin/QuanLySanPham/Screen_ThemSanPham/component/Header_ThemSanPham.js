...
function HeaderThemSanPham({navigation}) {
    return (
        <View style={styles.view_header}>
            ...
            <View style={styles.view_title}>
                <Text style={styles.title_nhanvien}>Thêm sản phẩm</Text>
            </View>
            <View onPress={()=>navigation.navigate("screenThemSanPham")} style={[styles.view_image, { alignItems: "flex-end", marginHorizontal: 10 }]}>
               
            </View>
        </View>
    );
}
export default HeaderThemSanPham;
